...
También existen sistemas operativos como Tails cuyo objetivo es el de preservar la 
seguridad y el anonimato
...
Una vez tengamos configurado I2P en nuestro equipo, podremos conectarnos a sus servidores 
y así aprovechar todo el software que esta red de anonimato nos ofrece. Entre las diferentes
aplicaciones, destacan:

\begin{itemize}
	\item Susimail: Interfaz web simple para emails 
	pensada en la seguridad y el anonimato.
	\item Syndie: Principal aplicación de distribución de contenidos diseñada para blogs,
	noticias y foros para I2P
	\item I2P Messenger: Cliente de mensajería instantánea con
	cifrado de extremo a extremo. Los mensajes no se almacenan en servidores para asegurar 
	el anonimato
	...
	\item También en Android... \\
	Nightweb, aplicación que usa I2P y BitTorrent para compartir entradas
